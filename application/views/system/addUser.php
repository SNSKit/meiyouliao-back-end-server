  ...
  <body>
	...
	<div id="main" class="clearfix">
	  ...
	  <div class="fr" id="rightMain">
	    <h2>添加用户</h2>
	    <form method="post" action="<?php echo $siteUrl;?>system/users/addDo">
		  <p>
		    <span>用户名：</span>
			<input type="text" id="username" name="username" placeholder="用户名/5-16位/不允许纯数字" />
		  </p>
		  <p>
		    <span>密&nbsp;&nbsp;&nbsp;码：</span>
		  ...
		  <p>
		    <span>email&nbsp;：</span>
			<input type="text" id="email" name="email" placeholder="电子邮箱/用于找回密码" />
		  </p>
		  <p>
		    <span>管理员：</span>
