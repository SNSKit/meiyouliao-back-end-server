  ...
  <head>
	...
	<style>
	  ...
	  *:first-child+html .clearfix{zoom:1;} 
	  ...
	  #rightMain form p input[type=text]{width:50px;border:1px solid black;height:30px;line-height:30px;}
  ...
  <body>
	...
	<div id="main" class="clearfix">
	  <div class="fl" id="leftMain">
	    <ul id="quick">
		  <li><a href="<?php echo $siteUrl;?>system/pic/">所有趣图</a></li>
		  <li><a href="<?php echo $siteUrl;?>system/pic/add">添加趣图</a></li>
		</ul>
	  </div>
	  <div class="fr" id="rightMain">
	    <h2>查看趣图</h2>
	    <form method="post" action="<?php echo $siteUrl;?>system/pic/editDo">
		  <p>
		    <span>昵称：</span>
